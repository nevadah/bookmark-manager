-- CreateEnum
CREATE TYPE "OrgRole" AS ENUM ('MEMBER', 'EDITOR', 'ADMIN');
...
-- AddForeignKey
ALTER TABLE "Bookmark" ADD CONSTRAINT "Bookmark_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
